package com.example.ghanim.qr.service;

import com.example.ghanim.qr.entities.FaceEntity;
...
public class FaceDetectionService {
    ...
    public byte[] toImage() {
        for (FaceEntity fc : faceEntities) {
            Imgproc.rectangle(image, new Point(fc.getX(), fc.getY()), new Point(fc.getX() + fc.getWidth(), fc.getY() + fc.getHeight()), new Scalar(0, 255, 0, 255),3);
        }
